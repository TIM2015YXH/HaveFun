...
def _topk(scores, K=40):
    ...
    topk_scores, topk_inds = torch.topk(scores.view(batch, cat, -1), K)
    #print("topk_scores.size:\t", topk_scores.size())
    #print(topk_scores)
    #print("topk_inds.size:\t", topk_inds.size())
    #print(topk_inds)
    topk_inds = topk_inds % (height * width)
    ...
    #print("topk_score.size:\t", topk_score.size())
    #print(topk_score)
    #print("topk_ind.size:\t", topk_ind.size())
    #print(topk_ind)
    ...
    #print("topk_score.size:\t", topk_score.size())
    #print("topk_inds.size:\t", topk_inds.size())
    #print("topk_clses.size:\t", topk_clses.size())
    #print("topk_ys.size:\t", topk_ys.size())
    #print("topk_xs.size:\t", topk_xs.size())
...
def ctdet_decode(heat, wh, reg=None, cat_spec_wh=False, K=100, boxes_only=False):
    batch, cat, height, width = heat.size()
