...
class DPT():
    def __init__(self, task='depth', device='cuda'):
        ...
        if task == 'depth':
            path = '/cpfs/shared/public/chenxingyu/pretrained_dfmodel/omnidata/omnidata_dpt_depth_v2.ckpt'
            ...
            path = '/cpfs/shared/public/chenxingyu/pretrained_dfmodel/omnidata/omnidata_dpt_normal_v2.ckpt'
...
if __name__ == '__main__':
    ...
    mask_path = opt.path.replace('img/test', 'mask/test')
    m = cv2.imread(mask_path, cv2.IMREAD_UNCHANGED)
    image = np.concatenate((image, m[...,None]),-1)
